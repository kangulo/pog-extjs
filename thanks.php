	...
	<body>
		<div class="main">
			<div class="left2">
				...
				<br />POG+ExtJS is an open source <h1>Thaks for your donative! I will apreciate </h1>&nbsp;which automatically generates clean &amp; tested Object Oriented code for your PHP4/PHP5 application. Over the years, we realized that a large portion of a PHP programmer's time is wasted on repetitive coding of the Database Access Layer of an application simply because different applications require different objects.
				<br />
				<br />

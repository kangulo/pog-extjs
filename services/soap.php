...
$server -> register('GenerateObjectController',
					array('objectName' => 'xsd:string',
						'attributeList' => 'tns:StringArray',
						'typeList' => 'tns:StringArray',
						'renderList' => 'tns:StringArray',
					...
					'rpc',
					'encoded',
					'Generates the controller appropriate object from supplied attributeList, typeList etc.'
					);
$server -> register('GenerateObjectExtjs',
					array('objectName' => 'xsd:string',
						'attributeList' => 'tns:StringArray',
						'typeList' => 'tns:StringArray',
						'renderList' => 'tns:StringArray',
 ...
 * @return base64 encoded string
 */
function GenerateObject($objectName, $attributeList, $typeList,$renderList,$language, $wrapper, $pdoDriver, $extjsVersion)
{
	require_once ("../include/configuration.php");
 ...
 * @return base64 encoded string
 */
function GenerateObjectController($objectName, $attributeList, $typeList,$renderList, $language, $wrapper, $pdoDriver,$extjsVersion)
{
	require_once ("../include/configuration.php");
	require_once ("../include/class.misc.php");
 ...
 * @return base64 encoded string
 */
function GenerateObjectExtjs($objectName, $attributeList, $typeList, $renderList, $language, $wrapper, $pdoDriver,$extjsVersion)
{
	require_once ("../include/configuration.php");
	require_once ("../include/class.misc.php");
	...
	if ($extjsVersion  == 30)
	{
		...
		$object->BeginObject();
		$object->CreateCargarFunction();
		$object->CreateJsonReaderFunction();
		$object->CreateFiltersFunction();
		$object->CreateProxyFunction();		
		$object->CreateLoadAndShowGridFunction();	
		$object->CreateLimpiarFunction();
		$object->CreateHabilitarFunction();
		$object->CreateDeshabilitarFunction();

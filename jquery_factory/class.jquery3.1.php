...
class ObjectJQueryBootstrap3
{
	...
	var $pdoDriver = "";
	var $language = 'php5.1';
	var $extjsVersion = 'JQB';
	var $arrayControls = array();

	function ObjectJQueryBootstrap3($objectName, $attributeList = '', $typeList ='', $renderList ='', $pdoDriver = '', $language = 'php5.1', $extjsVersion = '42')
	{
	...
	function CreateGridFunction()
	{
		...
		$this->string .= "\n *";
		$this->string .= "\n * Clase generada con POG+EXTJS - Jquery + Bootstrap with a responsive design integrada con Metodos CRUD.";
		$this->string .= "\n *";
